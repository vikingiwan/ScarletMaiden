...
screen main_menu:
    ...
    $ x+=300 
    imagebutton auto "res/gui/button_load_%s.png" ypos 550 xpos x focus_mask True  action ShowMenu('load') at main_eff2
    $ x+=300
    imagebutton auto "res/gui/button_options_%s.png" ypos 550 xpos x focus_mask True action ShowMenu('preferences') at main_eff3
    $ x+=300
    imagebutton auto "res/gui/button_quit_%s.png" ypos 550 xpos x focus_mask True action Quit(confirm=False) at main_eff5
...
screen navigation:
    tag menu
    add "res/gui/Secondary_Menu.jpg"
    $ x2=10
    
    
    imagebutton auto "res/gui/button_save_%s.png" xpos x2 ypos 550 focus_mask True action ShowMenu('save') 
    $ x2+=200
    imagebutton auto "res/gui/button_load_%s.png" xpos x2 ypos 550 focus_mask True action ShowMenu('load') 
    $ x2+=200 
    imagebutton auto "res/gui/button_options_%s.png" xpos x2 ypos 550 focus_mask True action ShowMenu('preferences') 
    $ x2+=240 
    imagebutton auto "res/gui/button_main_%s.png" xpos x2 ypos 550 focus_mask True action MainMenu() 
    $ x2+=200 
    imagebutton auto "res/gui/button_return_%s.png" xpos x2 ypos 550 focus_mask True action Return() 
    $ x2+=240 
    imagebutton auto "res/gui/button_quit_%s.png" xpos x2 ypos 550 focus_mask True action Quit() 
